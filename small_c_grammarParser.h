...
public:
  ...
  enum {
    ...
    RuleIfStatement = 4, RuleForStatement = 5, RuleForInit = 6, RuleWhileStatement = 7, 
    RuleReturnStatement = 8, RuleVarDeclaration = 9, RuleVarDeclarationNoSemi = 10, 
    RuleArrayDecl = 11, RuleExpression = 12, RuleExpression1 = 13, RuleAssignmentExpression = 14, 
    RuleConditionalExpression = 15, RuleRelationalExpression = 16, RuleAdditiveExpression = 17, 
    RuleMultiplicativeExpression = 18, RuleUnaryExpression = 19, RulePrefixOperator = 20, 
    RulePostfixExpression = 21, RulePostfixPart = 22, RulePrimaryExpression = 23
  };
  ...
  class VarDeclarationNoSemiContext;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    VarDeclarationNoSemiContext *varDeclarationNoSemi();
    ExpressionContext *expression();
  ...
  class  VarDeclarationNoSemiContext : public antlr4::ParserRuleContext {
  public:
    VarDeclarationNoSemiContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ID();
    ArrayDeclContext *arrayDecl();
    ExpressionContext *expression();
