...
public:
  ...
  enum {
    ...
    RuleIfStatement = 4, RuleForStatement = 5, RuleWhileStatement = 6, RuleReturnStatement = 7, 
    RuleVarDeclaration = 8, RuleAssignment = 9, RuleCondition = 10, RuleExpression = 11
  };
